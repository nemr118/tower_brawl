...
**Result: played on 2026-09-04 on build v0.0.27. The 6.5 s gap, the slow-motion window and the caption all stay as they are. Two new bugs, both when a screen reloads or wakes up inside the replay gap (backlog 13 in [[PASSDOWN]]), and one vague stall report (backlog 14). The phone fps numbers are still missing (no console on the S25 Ultra).**
